...
sudo env PATH=$TEST_BASE:/sbin:$PATH RUBYLIB=$TEST_LIB DISKTEST_LOGTO_FGDB=blip:3000 DISKTEST_REQUIRED_NUMBER_OF_DRIVES=1 DISKTEST_DISK_REGEX=xvd[bc] $EXTRA_OPTS ./bin/disktest
